...
urlpatterns = [
    ...
    path('meu-historico/', views.meu_historico_compras, name='meu_historico_compras'),
    ...
    path('categorias/<int:id>/', views.obter_categoria, name='obter_categoria'),
    ...
    path('fornecedores/<int:id>/', views.obter_fornecedor, name='obter_fornecedor'),
    ...
    path('produtos/<int:id>/', views.obter_produto, name='obter_produto'),
    ...
    path('clientes/<int:id>/', views.obter_cliente, name='obter_cliente'),
    ...
    path('api/clientes/<int:cliente_id>/vendas/', views.relatorio_vendas_cliente, name='relatorio_vendas_cliente'),
